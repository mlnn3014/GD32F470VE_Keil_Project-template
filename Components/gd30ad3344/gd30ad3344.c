...
#define GD30_CONFIG_MUX_SINGLE_BASE 0x4000U // 单端通道配置基值
#define GD30_CONFIG_MODE_CONTINUOUS 0x0000U // 连续转换模式
#define GD30_CONFIG_PULL_UP_ENABLE  0x0008U // pull-up enable bit
#define GD30_CONFIG_NOP_VALID       0x0002U // NOP valid bit
#define GD30_CONFIG_RESERVED        0x0001U // reserved bit 要保持

// 每个 PGA 档位对应的满量程, 单位 uV
