...
#define RTC_BSP_DEFAULT_YEAR    2026   // 默认年
#define RTC_BSP_DEFAULT_MONTH   1      // 默认月
#define RTC_BSP_DEFAULT_DAY     1      // 默认日
#define RTC_BSP_DEFAULT_WEEKDAY 4      // 默认星期
#define RTC_BSP_DEFAULT_HOUR    0      // 默认时
#define RTC_BSP_DEFAULT_MINUTE  0      // 默认分
#define RTC_BSP_DEFAULT_SECOND  0      // 默认秒
